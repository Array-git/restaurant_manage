...
<div class="container">
    ...
    <input class="btn btn-primary mb-3" type="submit" onclick="window.location.href='${addItems}'"
           value="Добавить позиции в заказ"><br>
    ...
    <input class="btn btn-primary mb-3" type="submit" onclick="window.location.href='${edit}'"
           value="Изменить заказ"><br>

    <c:url value="/closeOrder" var="close">
        <c:param name="orderId" value="${order.id}"></c:param>
    </c:url>
    <input class="btn btn-primary mb-3" type="submit" onclick="window.location.href='${close}'"
           value="Закрыть заказ"><br>
</div>
</body>
</html>